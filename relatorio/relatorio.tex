...
\begin{fichacatalografica}
	...
	\vspace{10mm}
	\indent
	\par{É permitida a menção, reprodução parcial ou integral e a transmissão entre bibliotecas deste trabalho, sem modificação
		de seu texto, em qualquer meio que esteja ou venha a ser fixado, para pesquisa acadêmica, comentários e citações, desde
			...
			\par{Os conceitos expressos neste trabalho são de responsabilidade do(s) autor(es) e do(s) orientador(es).}
			...
			\framebox[12.5cm]{\footnotesize
				\begin{minipage}{13cm}
				\vspace*{1mm}
				\parbox[t]{1.5cm}{\hspace{2mm} Z34r}%
				\parbox[t]{11cm}{\noindent Segre, J., Bramigk, V.}\\
				\parbox[t]{1.5cm}{\ }%
				\parbox[t]{11cm}{\noindent \hspace{4mm} Heurística Estática para Times Cooperativos de Robôs \hspace{1mm}/ \hspace{6mm} Jan Lucas de Lima Segre e Victor Bramigk - Rio de Janeiro : Instituto Militar de Engenharia, 2012.}\\
				\parbox[t]{1.5cm}{\ }%
				\parbox[t]{11cm}{\noindent \hspace{4mm}} \\
				[\baselineskip]
				\parbox[t]{1.5cm}{\ }%
				...
				[\baselineskip]
				\parbox[t]{1.5cm}{\ }%
				\parbox[t]{11cm}{\noindent \hspace{4mm} 1. Engenharia da computação. 2. Redes Neurais. 
				3. Lógica Nebulosa. 4. Otimização da Colônia de Formigas. Instituto Militar de Enh=genharia.}\\
				[\baselineskip]
				\parbox[t]{10cm}{\ }%
				\parbox[t]{4.0 cm}{}
				\end{minipage}%
...
\begin{folhadeaprovacao}
  ...
  \assinatura{\textbf{Maj Julio Cesar Duarte - D.Sc. do IME}}
  \assinatura{\textbf{Ricardo Choren Noya - Ph.D do IME}}
