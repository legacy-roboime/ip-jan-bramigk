...
formigas, algoritmo genético e recozimento simulado, e também, propõe um modelo
...
%nebulosa, redes neurais.
%% TAG_CRF: e CRFs (\textit{Conditional Random Fields})
%A partir do estudo detalhado foram definidos métodos de abordagem do
%problema.
%Verificou-se a necessidade de definir um modelo para as abordagens
%envolvedo ACO e SA, deixando esses métodos para futuras pesquisas.
%% TAG_CRF:
%% Foi necessário especificar o modelo de time nas abordagens
%% envolvendo ACO e SA, que tem como base os CRFs.
%A abordagem envolvendo
%lógica nebulosa se mostrou muito complexo para ser desenvolvido neste
%trabalho.
%Após um estudo mais aprofundado deseja-se futuramente
...
The goal of this paper is to study ways to, given the log of a match, foresee
...
approach the problem given the complexity to incorporate time awareness into it,
