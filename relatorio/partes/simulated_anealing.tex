...
No processo de recozimento de um metal, quantidade de energia interna livre esta intrinsecamente
...
uma heurística probabilística para se encontrar o mínimo global de uma função custo que possue
...
Com base na definições acima, tem-se o seguinte pseudo código para a meta-heurística SA:
